...
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.05, 1.0, 0.2, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.0, 0.02, 0.0, 1.0);
    vec4 bgColor2 = vec4(0.0, 0.08, 0.02, 1.0);
...
const InfinityShaderBackground = () => {
...
export default InfinityShaderBackground;
