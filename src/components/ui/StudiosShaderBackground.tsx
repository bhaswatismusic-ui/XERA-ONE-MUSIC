...
const fsSource = `
  ...
  const vec4 lineColor = vec4(1.0, 0.05, 0.05, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.02, 0.0, 0.0, 1.0);
    vec4 bgColor2 = vec4(0.08, 0.0, 0.0, 1.0);
...
export default StudiosShaderBackground;
