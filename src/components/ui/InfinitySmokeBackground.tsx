...
void main(){
  ...
  vec3 deepGreen = vec3(0.0, 0.25, 0.08);
  vec3 glowGreen = vec3(0.2, 0.8, 0.4);

  // Layered color for depth
  vec3 smokeColor = mix(deepGreen, neonGreen, pow(smoke, 0.7));
  smokeColor = mix(smokeColor, glowGreen, pow(smoke, 1.5) * 0.5);
...
export function InfinitySmokeBackground() {
...
export default InfinitySmokeBackground;
